        ...
        <div>
            ...
            <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-light)', borderRadius: 'var(--radius-lg)', padding: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
                    <h3 style={{ fontSize: '1rem' }}>📸 Galeria de Fotos ({images.length})</h3>
                ...
                <p style={{ fontSize: '0.78rem', color: 'var(--text-muted)', marginTop: 16 }}>Máximo 20 fotos. Cada foto até 10MB. Formatos: JPEG, PNG, WebP.</p>
            </div>
        </div>
    );
}
